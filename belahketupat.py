...
def hitung_luas_dan_keliling():
    try:
        ...
        if diagonal1 > 0 and diagonal2 > 0:
            ...
            hasil_text = f"Luas belah ketupat: {luas:.2f} satuan persegi\nKeliling belah ketupat: {keliling:.2f} satuan"
...
# Buat jendela utama
root = tk.Tk()
root.title("Hitung Keliling dan Luas Belah Ketupat")
...
label_judul = tk.Label(frame, text="Hitung Keliling dan Luas Belah Ketupat", font=("Arial", 16))
